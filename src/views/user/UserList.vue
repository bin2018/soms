<template>
	<section>
		...
		<el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
			<el-form :inline="true" :model="filters">
                ...
                <el-form-item label="用户名">
					<el-input v-model="filters.login" placeholder="用户名"></el-input>
				</el-form-item>
				<el-form-item>
		...
		<el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="login" label="用户名" width="200" sortable>
			</el-table-column>
            ...
            <el-table-column prop="groupName" label="公司" width="120" sortable>
			</el-table-column>
		</el-table>
